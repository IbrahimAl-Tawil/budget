        ...
        return (
          ...
          >
            <div className="flex items-center justify-between gap-2">
              <span className="text-[14px] font-semibold tracking-[-0.01em] text-[var(--color-of-ink)]">
                {p.name}
              </span>
              {selected ? (
                <span
            ...
            <div className="text-[11px] text-[var(--color-of-muted)]">
              <span className="of-num">{p.needs}</span> needs ·{" "}
              <span className="of-num">{p.wants}</span> wants ·{" "}
              <span className="of-num">{p.savings}</span> savings
            </div>
            <p className="text-[11.5px] leading-snug text-[var(--color-of-muted)]">{p.blurb}</p>
          </button>
        );
      })}
    </div>
