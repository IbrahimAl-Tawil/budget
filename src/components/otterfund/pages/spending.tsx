    ...
    <div className="of-enter of-page">
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            {money(totalSpent)}{" "}
            <span style={{ fontSize: 18, color: "var(--color-of-muted)", fontWeight: 400 }}>
      ...
      <section style={{ ...CARD, marginBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
          ...
          <span style={{ fontSize: 12.5, color: "var(--color-of-faint)" }}>{planMeta.name}</span>
        </div>
        <p style={{ fontSize: 12.5, color: "var(--color-of-muted)", margin: "6px 0 20px" }}>
      ...
      <section style={{ ...CARD, marginBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 20 }}>
          ...
          {!hasIncome && (
            <span style={{ fontSize: 12.5, color: "var(--color-of-clay)" }}>Add income in Settings for targets</span>
          )}
        </div>
        {plan.buckets.map((b) => {
            ...
            <div key={b.key} style={{ marginBottom: 16 }}>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, marginBottom: 7 }}>
                <span style={{ fontWeight: 500 }}>
                  {b.label}{" "}
                  <span style={{ color: "var(--color-of-faint)", fontWeight: 400 }}>· {b.targetPct}%</span>
                </span>
                <span className="of-num" style={{ color: over ? theme.clay : "var(--color-of-muted)" }}>
                  {money(b.actualAmount)}{" "}
                  <span style={{ color: "var(--color-of-faint)" }}>/ {money(b.targetAmount)}</span>
                </span>
              </div>
          ...
          return (
            <div key={bucket.key}>
              ...
              {bucket.categories.length > 0 ? (
                ...
                <p style={{ fontSize: 13, color: "var(--color-of-muted)", padding: "6px 0 2px" }}>
                  {isSavings
