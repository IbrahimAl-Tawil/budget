...
// otterfund BRAND KIT — the live design-system showcase.
//
...
export function OtterfundBrandKit({ accent, theme, onAccentChange }: OtterfundBrandKitProps) {
  ...
  const palette: { name: string; role: string; value: string; fixed?: boolean }[] = [
    { name: "Canvas", role: "Background", value: "var(--color-of-canvas)" },
    { name: "Surface", role: "Cards", value: "var(--color-of-surface)" },
  ...
  return (
    <div className="of-enter of-page">
      ...
      >
        ...
        <div className="of-scheme-grid" style={{ display: "grid", gridTemplateColumns: `repeat(${BANKNOTE_SCHEMES.length}, 1fr)`, gap: 12 }}>
        ...
        <div style={{ marginTop: 22, paddingTop: 20, borderTop: "1px solid var(--color-of-line-soft)" }}>
            ...
            <div key={d.name} style={{ display: "grid", gridTemplateColumns: "14px 1fr", alignItems: "center", gap: 12 }}>
              ...
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                  ...
                  <span className="of-num" style={{ fontSize: 13.5, fontWeight: 600 }}>{d.amount}</span>
                </div>
                <div style={{ height: 6, borderRadius: 999, background: "var(--color-of-track)", overflow: "hidden" }}>
                  <div
                    style={{
                      height: "100%",
      ...
      >
        ...
        <div className="of-grid-swatches" style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 12 }}>
          {palette.map((p) => (
            <div key={p.name}>
              <div
                style={{
      ...
      >
        ...
        >
          ...
          {/* The real ProgressBar + ProgressRing (otterfund/progress) — the same
      ...
      >
        ...
        <div className="of-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
          {motions.map((mItem) => (
            <div
              key={mItem.title}
              style={{
...
function TunerSlider({
  ...
  return (
    <label style={{ display: "grid", gridTemplateColumns: "64px 1fr 56px", alignItems: "center", gap: 12 }}>
      ...
      />
      <span className="of-num" style={{ fontSize: 12.5, color: "oklch(54% 0.012 80)", textAlign: "right" }}>
        {value}
        {suffix}
      </span>
    </label>
