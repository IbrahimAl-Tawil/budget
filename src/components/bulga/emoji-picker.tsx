    ...
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div
          ...
          className="bk-enter absolute z-50 mt-2 left-0 w-[244px] rounded-2xl border border-[var(--color-bk-line)] bg-[var(--color-bk-surface)] p-3 shadow-[0_12px_32px_oklch(20%_0.02_80/0.12)]"
        >
          ...
          <button
            type="button"
            onClick={() => pick("")}
            className="mt-2 w-full h-8 rounded-lg text-[12.5px] font-medium text-[var(--color-bk-muted)] hover:bg-[oklch(95%_0.005_90)] transition-colors"
          >
            ✕ None
          </button>
        </div>
